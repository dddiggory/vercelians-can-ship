    ...
    <main className="flex min-h-screen flex-col items-center justify-between p-8 lg:p-24">
        
        {
          !profileData ? (
            ...
            <div className={`col-span-4 text-2xl bg-amber-50 lg:dark:bg-zinc-800/30 space-y-2 fixed left-0 top-0 w-full p-8 justify-center border-b border-gray-300 pb-6 pt-8 backdrop-blur-2xl lg:static lg:w-auto  lg:rounded-xl lg:border dark:bg-zinc-800/30 dark:from-inherit ${true==false ? ' bg-gradient-to-b from-zinc-200  lg:bg-gray-200 lg:p-4 dark:border-neutral-800' : null}`}>
          ...
          : (
            ...
            <div className="grid grid-cols-5 gap-5 mx-2 h-[100px] w-[500px] md:w-[720px] lg:w-[1000px] xl:w-[1200px] 2xl:w-[1500px]">
              <div className="col-span-4 rounded-2xl bg-white">
                <div className="grid grid-cols-2 lg:grid-cols-4 my-5 mx-0">
                  ...
                  {profileData.avatar_url ? (
                    <img 
                      ...
                      height="0"
                      width="0"
                      className="rounded-3xl w-[110px] md:w-[140px]" 
                      alt="a picture of the developer of this page" />
                  ) : (
                    null
                  )}
                  </div>
                  <div className="lg:col-span-3 justify-left">
                    <p className="text-xs">welcome to</p>
                    <p className="text-4xl lg:text-6xl font-semibold pb-0 bg-gradient-to-r from-emerald-400 to-cyan-400 bg-clip-text text-transparent">{profileData.name}&apos;s</p>
