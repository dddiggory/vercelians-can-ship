      ...
      <div>
        {!profileData ? (
          <div>
            ...
            Start by clicking <a href="https://github.com/dddiggory/vercelians-can-code" target="_blank" className="underline text-blue-800">&apos;Use This Template&apos; on Github</a> to make your own copy and deploy it to Vercel.
